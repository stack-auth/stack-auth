...
- [`user.getItem()`](/docs/sdk/types/user#currentusergetitem)
- [`user.useItem()`](/docs/sdk/types/user#currentuseruseitem) (React hook)
- [`team.getItem()`](/docs/sdk/types/team#teamgetitem)
- [`team.useItem()`](/docs/sdk/types/team#teamuseitem) (React hook)
...
<ResponseField name="displayName" type="string">
  The human-readable name of the item as configured in your Stack Auth project
  settings.
</ResponseField>

<ResponseField name="quantity" type="number">
  The current quantity. This value can be negative, which is useful for tracking
  overdrafts or pending charges.
</ResponseField>

<ResponseField name="nonNegativeQuantity" type="number">
  The quantity clamped to a minimum of 0. Equivalent to `Math.max(0, quantity)`.
  Useful for display purposes when you don't want to show negative values to
  users.
</ResponseField>
...
- [`serverUser.getItem()`](/docs/sdk/types/user#serverusergetitem)
- [`serverUser.useItem()`](/docs/sdk/types/user#serveruseruseitem) (React hook)
- [`serverTeam.getItem()`](/docs/sdk/types/team#serverteamgetitem)
- [`serverTeam.useItem()`](/docs/sdk/types/team#serverteamuseitem) (React hook)

```typescript
type ServerItem =
  // Inherits all functionality from Item
  Item & {
    increaseQuantity(amount): Promise<void>;
    decreaseQuantity(amount): Promise<void>;
    tryDecreaseQuantity(amount): Promise<boolean>;
  };
```

## Methods

### `serverItem.increaseQuantity(amount)`
...
### `serverItem.decreaseQuantity(amount)`
...
### `serverItem.tryDecreaseQuantity(amount)`
