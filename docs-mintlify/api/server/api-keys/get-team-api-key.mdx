---
title: "Get Team API Key Details"
description: "Get details of a specific team API key."
api: "GET /api/v1/team-api-keys/{api_key_id}"
---
...
<ParamField path="api_key_id" type="string" required>
  The unique identifier of the team API key.
</ParamField>
...
<CodeGroup>
```bash cURL
curl -X GET 'https://api.stack-auth.com/api/v1/team-api-keys/tak_1234567890' \
