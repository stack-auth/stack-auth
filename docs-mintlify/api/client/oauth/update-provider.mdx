...
description: "Updates an existing OAuth provider connection for a user."
...
<ParamField path="provider_id" type="string" required>
  The identifier of the OAuth provider being modified.
</ParamField>
...
<CodeGroup>
```bash cURL
curl -X PATCH 'https://api.stack-auth.com/api/v1/oauth-providers/me/google' \
