...
<AccordionGroup>
  ...
  <Accordion title="How do I sign in with Google from iOS?">
    Use the [Swift SDK](https://github.com/hexclave/swift-sdk-prerelease) `signInWithOAuth(provider: "google")` when you can. The REST authorize and token steps are on the [Google provider page](/guides/apps/authentication/auth-providers/google#native-apps).
  </Accordion>
