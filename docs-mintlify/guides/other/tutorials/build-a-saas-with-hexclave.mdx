...
- `stack/server.ts` - `hexclaveServerApp` for server components, actions, and route handlers
- `stack/client.ts` - `hexclaveClientApp` when you need the client app object explicitly
