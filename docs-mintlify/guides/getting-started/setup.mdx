...
- **TanStack Start**: A [TanStack Start project](https://tanstack.com/start/latest/docs/framework/react/quick-start)
...
<Steps>
  ...
  <Step title="Create Stack configuration">
    ...
    <Tabs>
      ...
      <Tab title="TanStack Start">
        ```typescript title="src/stack/client.ts"
  ...
  <Step title="Set up authentication handlers (Frontend frameworks only)">
    ...
    <Tabs>
      ...
      <Tab title="TanStack Start">
        ```typescript title="src/routes/handler/$.tsx"
  ...
  <Step title="Add providers (Next.js, TanStack Start, and React only)">
    For Next.js, TanStack Start, and React, wrap your app with Stack providers:
