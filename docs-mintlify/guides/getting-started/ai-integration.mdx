...
description: Teach your coding agent how to use Stack Auth — via web fetch, an installable skill, or the Stack Auth MCP server.
...
<CardGroup cols={3}>
  <Card title="Web Fetch" icon="wand-magic-sparkles" href="#option-3-web-fetch">
