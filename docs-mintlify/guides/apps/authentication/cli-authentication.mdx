...
<Info>
  This page is about adding authentication to your own CLI app. For the official `hexclave` command, see the [Hexclave CLI guide](/guides/going-further/cli).
</Info>
