...
<Steps>
  <Step title="Create a Discord Developer App">
    ...
    5. Under **Redirects** add `https://api.hexclave.com/api/v1/auth/oauth/callback/discord`
...
- Visit our [Discord Support Channel](https://discord.hexclave.com)
