...
Payouts are handled by Stripe for the connected account you set up in **Payments -> Settings**. Hexclave handles checkout, purchases, subscriptions, invoices, and entitlements; Stripe remains the source of truth for bank payouts, payout timing, and payout history.
