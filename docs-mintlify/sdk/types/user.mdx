...
<ClickableTableOfContents
  ...
  & {
    ...
    listTeamsPaginated([options]): Promise<ServerTeam[] & { nextCursor: string | null }>; //$stack-link-to:#serveruserlistteamspaginated
    useTeamsPaginated([options]): ServerTeam[] & { nextCursor: string | null }; //$stack-link-to:#serveruseruseteamspaginated
...
<ServerUserSection type="serverUser" property="listTeamsPaginated" signature="[options]" defaultOpen={false}>
  <MethodLayout>
    <MethodContent>
      ...
      <MethodReturns type="Promise<ServerTeam[] & { nextCursor: string | null }>" />
    </MethodContent>
    ...
    <MethodAside>
      <AsideSection title="Signature">
        ...
        declare function useTeamsPaginated(options?: {
          ...
          desc?: boolean;
          query?: string;
        }): ServerTeam[] & { nextCursor: string | null };
        ```
      </AsideSection>
    </MethodAside>
