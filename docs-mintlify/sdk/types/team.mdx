...
Options for creating a team via [`user.createTeam()`](/docs/sdk/types/user#currentusercreateteam).
...
Represents an invitation received by a user. Returned by [`user.listTeamInvitations()`](/docs/sdk/types/user#currentuserlistteaminvitations).
