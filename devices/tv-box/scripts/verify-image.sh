...
required='usr/lib/hexclave-tv-box/kiosk-launch usr/lib/python3/dist-packages/hexclave_tv_box/network_agent.py etc/systemd/system/hexclave-tv-box-kiosk.service etc/ssh/hexclave-support-ca.pub etc/hexclave-tv-box-release'
