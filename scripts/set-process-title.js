...
process.title = `[hexclave:${process.env.NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX || 81}xx] ${process.title || shortenedCommand.length > 200 ? shortenedCommand.slice(0, 200) + '...' : shortenedCommand}`;
