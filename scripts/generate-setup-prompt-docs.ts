...
import { llmsFullTxt, llmsTxt } from "../packages/stack-shared/src/ai/llms/llms";
...
writeFileSyncIfChanged(
  path.join(repoRoot, "packages/stack-shared/src/ai/llms/llms-content.generated.ts"),
  deindent`
    // This file is generated from the unified Hexclave prompts.

    export const generatedLlmsTxt = ${JSON.stringify(llmsTxt)};

    export const generatedLlmsFullTxt = ${JSON.stringify(llmsFullTxt)};
  ` + "\n",
);
