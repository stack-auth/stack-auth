...
2. Set the project **Root Directory** to `docs-legacy-redirects`.
3. Attach the `docs.stack-auth.com` domain to this project.
4. Deploy — no build step is required; `vercel.json` handles all redirects.
