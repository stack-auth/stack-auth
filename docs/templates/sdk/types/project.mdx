---
title: Project
description: The Project object contains the information and configuration of a project, such as the name, description, and enabled authentication methods.
full: true
---
