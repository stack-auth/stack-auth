...
description: The TeamPermission object represents a permission that a user has within a team. Currently, it contains only an id to specify the permission.
full: true
---
