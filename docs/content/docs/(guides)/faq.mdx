...
## Product
<AccordionGroup>
  <Accordion title="Can I try Stack Auth without creating a project?">
    Yes! Visit the Stack Auth dashboard and start Preview Mode to explore the interface with mock data. Preview Mode includes an interactive walkthrough of key features. Note that payments, webhooks, email sending, and session replays are disabled in Preview Mode. When you're ready, you can create a real project at any time.
  </Accordion>
