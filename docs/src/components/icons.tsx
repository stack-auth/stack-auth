...
// Hexclave Logo Component (benzene mark)
  ...
  ({ className, size = 40, color = 'currentColor', ...props }, ref) => {
    return (
      ...
      >
        ...
        <path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill={color} stroke="none"/>
        <path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill={color} stroke="none" transform="rotate(120 24 24)"/>
        <path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill={color} stroke="none" transform="rotate(240 24 24)"/>
      </svg>
    );
  }
);
