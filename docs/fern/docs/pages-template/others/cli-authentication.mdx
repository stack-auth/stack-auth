...
To do so, we provide a Python template that you can use as a starting point. [Download it here](/assets/stack_auth_cli.py) and copy it into your project, for example:
