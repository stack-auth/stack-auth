...
type ApiKey<Type extends "user" | "team" = "user" | "team", IsFirstView extends boolean = false> = {
  ...
  manuallyRevokedAt: Date | null;  //$stack-link-to:#apikeymanuallyrevoked
...
The date and time when this API key will expire. If undefined, the key does not expire.
