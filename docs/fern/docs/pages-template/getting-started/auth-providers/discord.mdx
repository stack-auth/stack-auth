...
<Steps>
  ...
  <img 
    src="../../imgs/auth-providers/discord-oauth-callback.png" 
    alt="Discord OAuth callback URL configuration" 
  />

  6. Click **Save Changes**
  7. Save the **Client ID** and **Client Secret**. You may need to select **Reset Secret** to generate a new one.
  ...
  <img
    src="../../imgs/auth-providers/discord-oauth-setup-stack.png" 
    alt="Adding client ID and secret to Stack Auth" 
  />
</Steps>
