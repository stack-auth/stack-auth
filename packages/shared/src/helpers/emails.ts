...
const EMAIL_TEMPLATE_TRIAL_WILL_END_ID = "c3f8a1d2-7e4b-4a91-b2c5-9e8f1a0d3b6c";
...
export const DEFAULT_TEMPLATE_IDS = {
  ...
  trial_will_end: EMAIL_TEMPLATE_TRIAL_WILL_END_ID,
} as const;
