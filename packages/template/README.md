...
We support Next.js, React Router, TanStack Start, Nuxt, SvelteKit, NestJS, Express, Hono, Cloudflare Workers, and generic JavaScript runtimes through our JavaScript SDK packages, along with any backend that can use our [REST API](https://docs.stack-auth.com/rest-api/overview). Check out our [setup guide](https://docs.stack-auth.com/getting-started/setup) to get started.
