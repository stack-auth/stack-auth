...
import { EventTracker, getCustomTelemetryDataError, getCustomTelemetryNameError, rejectedPreCaught, resolveParentIds, withSpanImpl, type Span, type StartSpanOptions, type TrackOptions } from "./event-tracker";
