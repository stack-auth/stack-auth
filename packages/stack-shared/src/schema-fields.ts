...
export const oauthProviderIsSharedSchema = yupBoolean().meta({ openapiField: { description: 'Whether the OAuth provider is shared. If this is set to `true`, it will use Stack Auth\' shared OAuth keys and it is only meant for development.', exampleValue: true } });
