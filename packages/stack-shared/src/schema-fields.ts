...
export const signedUpAtMillisSchema = yupNumber().nullable().meta({ openapiField: { description: _signedUpAtMillisDescription + ' Null for anonymous users who have not yet upgraded.', exampleValue: 1630000000000 } });
