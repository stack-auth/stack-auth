...
export const oauthIssuerSchema = yupString().meta({ openapiField: { description: 'The issuer URL for the OAuth provider. This is only required if you are using the standard OAuth with Issuer.' } });
