...
export const emailThemeSchema = yupString().oneOf(['light', 'dark']).meta({ openapiField: { description: 'Email theme for the project. Determines the visual style of emails sent by the project.', exampleValue: 'light' } });
