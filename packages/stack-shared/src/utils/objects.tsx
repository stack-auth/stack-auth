...
export function set<T extends object, K extends keyof T>(obj: T, key: K, value: T[K]) {
  if (!isObjectLike(obj)) throw new StackAssertionError("set: obj is not an object", { obj, key, value });
...
export function get<T extends object, K extends keyof T>(obj: T, key: K): T[K] {
  if (!isObjectLike(obj)) throw new StackAssertionError("get: obj is not an object", { obj, key });
...
export function getOrUndefined<T extends object, K extends keyof T>(obj: T, key: K): T[K] | undefined {
  if (!isObjectLike(obj)) throw new StackAssertionError("getOrUndefined: obj is not an object", { obj, key });
...
export function has<T extends object, K extends keyof T>(obj: T, key: K): obj is T & { [k in K]: unknown } {
  if (!isObjectLike(obj)) throw new StackAssertionError("has: obj is not an object", { obj, key });
