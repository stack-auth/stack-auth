...
export const usersCrudServerUpdateSchema = fieldSchema.yupObject({
  ...
  country_code: fieldSchema.countryCodeSchema.nullable().optional().meta({ openapiField: { description: 'Best-effort ISO country code captured at sign-up time from request geo headers.', exampleValue: "US" } }),
...
export const usersCrudServerReadSchema = fieldSchema.yupObject({
  ...
  country_code: fieldSchema.countryCodeSchema.nullable().defined().meta({ openapiField: { description: 'Best-effort ISO country code captured at sign-up time from request geo headers.', exampleValue: "US" } }),
  risk_scores: fieldSchema.yupObject({
    sign_up: fieldSchema.yupObject({
