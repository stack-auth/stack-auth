...
export function Netsuite({ iconSize }: { iconSize: number }) {
  return (
    <svg width={iconSize} height={iconSize} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 275 92.7">
      <g>
        <path fill="#FFFFFF" d="M4.1,92V57.9h6.8l14.8,22.3V57.9h7.3V92h-6.8L11.4,69.7V92H4.1z">
        </path>
        <path fill="#FFFFFF" d="M39.7,92V57.9h22.3v6.3H47.2v7.5h13.5v6.3H47.2v8h15.2v5.8L39.7,92z">
        </path>
        <path fill="#FFFFFF" d="M76.5,92V63.9H66.3v-6h27.3v6.3H83.5V92H76.5z">
        </path>
        <path fill="#FFFFFF" d="M98.2,90.3v-3.9c3.1,1.5,6.5,2.2,9.9,2.2c2.2,0.2,4.4-0.5,6-1.5c1.5-1,2.2-2.7,2.2-4.4c0-1.2-0.5-2.4-1.5-3.4
       ...
       c-2.7,1.9-5.8,2.7-9,2.7c-1.2,0-2.4,0-3.6-0.2c-1.2-0.2-2.4-0.5-3.6-0.7C99.9,91.2,98.9,90.8,98.2,90.3z">
        ...
        <path fill="#FFFFFF" d="M126.3,76.5V57.9h4.4v18.6c0,4.1,0.7,7.3,2.2,9.2c3.4,3.6,9.2,4.1,12.8,0.7c0.2-0.2,0.5-0.5,0.7-0.7
       ...
       C127.5,86.2,126.3,82.1,126.3,76.5z">
        ...
        <path fill="#FFFFFF" d="M160.1,92V57.9h4.4V92H160.1z">
        </path>
        <path fill="#FFFFFF" d="M181.2,92V61.5h-10.6v-3.6h25.9v3.6h-10.9v30.2h-4.4V92z">
        </path>
        <path fill="#FFFFFF" d="M202.2,92V57.9h21v3.6h-16.7v11.1h15.2v3.6h-15.2v11.6h17.2v3.6h-21.5L202.2,92L202.2,92z">
        </path>
        <path fill="#FFFFFF" d="M118.6,23.2h18.1l-9.5-15.5l-17.7,27.9h-8.1l21.5-33.4c1.7-2.4,4.8-2.9,7.2-1.2c0.5,0.2,1,0.5,1.2,1l21.5,33.6
...
export function Mapping({
  ...
  switch (provider) {
    ...
    case "netsuite": {
      return <Netsuite iconSize={iconSize} />;
    }
    default: {
