...
# Hexclave rebrand: port-prefix var renamed outright to NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX;
# accept the legacy NEXT_PUBLIC_STACK_PORT_PREFIX as a fallback input.
PORT_PREFIX="${PORT_PREFIX:-${NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX:-${NEXT_PUBLIC_STACK_PORT_PREFIX:-81}}}"
