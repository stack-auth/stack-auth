...
const entries = [
  ...
  literal("STACK_SEED_INTERNAL_PROJECT_PUBLISHABLE_CLIENT_KEY", "local-emulator-publishable-client-key"),
  literal("STACK_SEED_INTERNAL_PROJECT_SECRET_SERVER_KEY", "local-emulator-secret-server-key"),
  literal("STACK_SEED_INTERNAL_PROJECT_SUPER_SECRET_ADMIN_KEY", "local-emulator-super-secret-admin-key"),
  blank(),
  ...
  literal("STACK_FREESTYLE_API_ENDPOINT", "http://127.0.0.1:8180"),
  literal("STACK_STRIPE_MOCK_PORT", "12111"),
  literal("NEXT_PUBLIC_STACK_STRIPE_PUBLISHABLE_KEY", "pk_test_mock_publishable_key_for_local_emulator"),
