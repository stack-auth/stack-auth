...
<Callout>([
Welcome to the Next.js SDK setup guide. If you're looking for guides for other frameworks, check out the [React SDK Setup](/reactgetting-started/setup), or the [JavaScript SDK Setup](/jsgetting-started/setup).
])</Callout>
