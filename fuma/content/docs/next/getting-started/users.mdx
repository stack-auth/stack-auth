...
<Tabs>
  <Tab value="Middleware" label="Middleware">
  ...
  <Tab value="Client Component" label="Client Component">
  ...
  <Tab value="Server Component" label="Server Component">
...
<Tabs>
  <Tab value="user.signOut()" label="user.signOut()">
  ...
  <Tab value="Redirect" label="Redirect">
