...
<Tabs>
  <Tab value="index.html" label="index.html">
    ```html
    <!DOCTYPE html>
    <html lang="en">
    <head>
  ...
  <Tab value="index-script.ts" label="index-script.ts">
    ```typescript
...
<Tabs>
  <Tab value="password-sign-in.html" label="password-sign-in.html">
    ```html
    <!DOCTYPE html>
    <html lang="en">
    <head>
  ...
  <Tab value="password-sign-in-script.ts" label="password-sign-in-script.ts">
    ```typescript
    import { stackClientApp } from "./stack";
...
<Tabs>
  <Tab value="password-sign-up.html" label="password-sign-up.html">
    ```html
    <!DOCTYPE html>
    <html lang="en">
    <head>
  ...
  <Tab value="password-sign-up-script.ts" label="password-sign-up-script.ts">
    ```typescript
    import { stackClientApp } from "./stack";
...
<Tabs>
  <Tab value="otp-sign-in.html" label="otp-sign-in.html">
    ```html
    <!DOCTYPE html>
    <html lang="en">
    <head>
  ...
  <Tab value="otp-sign-in-script.ts" label="otp-sign-in-script.ts">
    ```typescript
    import { stackClientApp } from "./stack";
...
<Tabs>
  <Tab value="oauth.html" label="oauth.html">
    ```html
    <!DOCTYPE html>
    <html lang="en">
    <head>
  ...
  <Tab value="oauth-script.ts" label="oauth-script.ts">
    ```typescript
    import { stackClientApp } from "./stack";
