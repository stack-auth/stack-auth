    ...
    NiceResponse {
      ...
      "body": {
        "result": [
          ...
          { "GRANTS WITH IMPLICIT FINAL FORMAT JSONEachRow": "GRANT SHOW TABLES, SHOW COLUMNS, SELECT ON default.team_members TO limited_user" },
    ...
    NiceResponse {
      ...
      "body": {
        "result": [
          ...
          { "GRANTS FORMAT JSONEachRow": "GRANT SELECT ON default.team_members TO limited_user" },
