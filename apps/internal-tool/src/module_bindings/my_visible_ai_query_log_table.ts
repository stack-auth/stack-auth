...
export default __t.row({
  ...
  cacheCreationTokens: __t.option(__t.u32()).name("cache_creation_tokens"),
  costUsd: __t.option(__t.f64()).name("cost_usd"),
  cacheDiscountUsd: __t.option(__t.f64()).name("cache_discount_usd"),
  openrouterGenerationId: __t.option(__t.string()).name("openrouter_generation_id"),
