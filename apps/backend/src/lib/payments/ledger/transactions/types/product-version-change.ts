...
export function getProductVersionChangeTransactions(_prisma: PrismaClientTransaction, _tenancyId: string): PaginatedList<Transaction, string, TransactionFilter, TransactionOrderBy> {
