...
export function getSubscriptionChangeTransactions(_prisma: PrismaClientTransaction, _tenancyId: string): PaginatedList<Transaction, string, TransactionFilter, TransactionOrderBy> {
