...
// This file is split out from email-queue-step.test.tsx because it mocks
// `@/prisma-client` at module scope (vi.mock is hoisted), which would
// otherwise break the real-DB integration tests for failEmailsStuckInSending
// that live in the sibling test file.
