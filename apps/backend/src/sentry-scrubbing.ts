...
export function sanitizeBackendSentryEvent<T extends Event>(event: T): T {
  ...
  let safeRequestContext: { requestId: string, method?: string, route?: string } | undefined;
  if (typeof requestId === "string") {
    safeRequestContext = { requestId };
    if (typeof requestMethod === "string") safeRequestContext.method = requestMethod;
    if (typeof requestRoute === "string") safeRequestContext.route = requestRoute;
  }
