...
export const GET = createSmartRouteHandler({
  metadata: {
    ...
    description: "Gets an email theme for a project",
    tags: ["Emails"],
  },
  request: yupObject({
    auth: yupObject({
...
export const PATCH = createSmartRouteHandler({
  metadata: {
    summary: "Update email theme",
    description: "Updates an email theme for a project",
    tags: ["Emails"],
  },
  request: yupObject({
    auth: yupObject({
...
export const DELETE = createSmartRouteHandler({
  metadata: {
    ...
    description: "Deletes an email theme for a project",
    tags: ["Emails"],
  },
  request: yupObject({
    auth: yupObject({
  ...
  async handler({ auth: { tenancy }, params: { id } }) {
    ...
    if (tenancy.config.email_theme === themeList[id].displayName) {
      throw new StatusError(400, "Cannot delete the active email theme");
    }
    
    // Remove the theme from the list
    const { [id]: deletedTheme, ...remainingThemes } = themeList;
