import { rediscoverSource } from "@/lib/data-warehouse/api";
...
export const POST = createSmartRouteHandler({
  ...
  response: yupObject({
    ...
    body: yupObject({
      streams: yupArray(yupMixed().defined()).defined(),
    }).defined(),
  }),
  async handler({ auth: { tenancy }, params }) {
    return {
      statusCode: 200,
      bodyType: "json",
      body: { streams: await rediscoverSource(tenancy, params.source_id) },
    };
  },
});
