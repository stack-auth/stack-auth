import { runDataWarehouseSyncStep } from "@/lib/data-warehouse/sync";
...
/**
 * Cron entry point for Data Warehouse, alongside the email-queue, external-db-sync
...
export const GET = createSmartRouteHandler({
  ...
  handler: async ({ headers, query }) => {
    ...
    while (true) {
      ...
      const { didWork } = await runDataWarehouseSyncStep();
      steps += 1;
      if (!didWork) break;
