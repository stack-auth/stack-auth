...
import { createOrUpdateProject, legacyConfigToNewConfig } from "@/lib/projects";
...
import { yupArray, yupObject, yupString } from "@stackframe/stack-shared/dist/schema-fields";
  ...
  onUpdate: async ({ auth, data }) => {
    ...
    const project = await createOrUpdateProject({
      ...
      data: {
        ...
        is_production_mode: data.is_production_mode,
      },
      environmentConfigOverrideOverride: legacyConfigToNewConfig(data.config),
    });
