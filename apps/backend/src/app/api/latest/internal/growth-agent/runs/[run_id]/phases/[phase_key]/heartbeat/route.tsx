...
import { heartbeatGrowthAgentPhase } from "@/lib/growth/agent-writes";
...
export const POST = createSmartRouteHandler({
  ...
  handler: async ({ headers, params, body }) => {
    ...
    await heartbeatGrowthAgentPhase({ tenancy, runId: params.run_id, phaseKey: params.phase_key, attempt: body.attempt });
