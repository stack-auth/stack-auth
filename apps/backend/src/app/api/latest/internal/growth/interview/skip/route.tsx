...
import { skipGrowthInterview } from "@/lib/growth/interview";
...
export const POST = createSmartRouteHandler({
  ...
  handler: async ({ auth }) => {
    ...
    // Ack returns the resulting interview status, per the frozen dashboard contract.
    return { statusCode: 200, bodyType: "json", body: await skipGrowthInterview(auth.tenancy) };
  },
});
