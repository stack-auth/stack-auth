...
// Query params arrive as strings; parsed by hand (same as the session-replays internal route) so a
// garbage value is a clean 400 instead of a yup coercion surprise.
