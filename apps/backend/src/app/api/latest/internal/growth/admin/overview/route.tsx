import { getGrowthAdminOverview } from "@/lib/growth/admin";
...
export const GET = createSmartRouteHandler({
  ...
  handler: async ({ auth, query }) => ({ statusCode: 200, bodyType: "json", body: await getGrowthAdminOverview(auth.project.id, auth.user, query.project_id) }),
});
