...
export const GET = createSmartRouteHandler({
  ...
  handler: async (req) => {
    try {
      ...
      captureError("compliance-security-posture-query", new HexclaveAssertionError(
        "Failed to load security posture.",
        { cause: error },
      ));
      throw new StatusError(StatusError.ServiceUnavailable, "Security posture is temporarily unavailable.");
    }
  },
});
