...
import { numberCompare } from "@stackframe/stack-shared/utils/numbers";


// SmartRouter may be imported on the edge, so we can't import fs at the top level
// hence, we define some wrapper functions
const listRecursively: typeof import("@stackframe/stack-shared/utils/fs").listRecursively = async (...args) => {
  // SmartRouter may be imported on the edge, so we can't import fs at the top level
  // hence, this wrapper function
  const m = await import("@stackframe/stack-shared/utils/fs");
