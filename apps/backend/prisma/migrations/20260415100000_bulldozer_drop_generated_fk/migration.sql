...
-- trigger-maintained column, and drop the self-referential FK.
--
-- Motivation: Prisma's Unsupported type cannot represent generated columns or
-- FK constraints on unsupported types, causing a persistent schema drift in CI.
-- The FK also adds unnecessary overhead (insert ordering, cascade behavior).
