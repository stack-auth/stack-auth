...
-- trigger-maintained. This avoids future full-table rewrites when the status
-- precedence changes again, while letting older app versions keep omitting the
-- formerly generated status column.
