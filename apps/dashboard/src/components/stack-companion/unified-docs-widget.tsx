...
// Title mapping for dashboard pages
...
const getDocContentForPath = (path: string, docType: DocType): DocContent => {
  switch (docType) {
    case 'dashboard': {
      ...
      // For overview page, use the main docs overview instead of dashboard overview
      if (page === 'overview') {
        const url = `http://localhost:8104/docs-embed/next/overview`;
        const title = 'Stack Auth Overview';
    ...
    case 'docs': {
      ...
      const url = `http://localhost:8104/docs-embed/getting-started/setup`;
    ...
    <div className="flex flex-col h-full">
      ...
      {docContent && !error && (
        <div className="flex-1 flex flex-col min-h-0 relative">
          ...
          {/* Header with back button, title and external link */}
          <div className="flex items-center justify-between pb-2 mb-3 border-b">
            ...
            <a
              href={docContent.url.replace('-embed', '')} // Remove -embed for external links
              target="_blank"
