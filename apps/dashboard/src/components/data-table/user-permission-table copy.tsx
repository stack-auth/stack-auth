...
import { AdminUserPermissionDefinition } from "@stackframe/stack";
...
function EditDialog(props: {
  ...
  return <SmartFormDialog
    ...
    onSubmit={async (values) => {
      await stackAdminApp.updateUserPermissionDefinition(props.selectedPermissionId, values);
    }}
    cancelButton
  />;
}
...
function DeleteDialog(props: {
  permission: AdminUserPermissionDefinition,
  open: boolean,
  onOpenChange: (open: boolean) => void,
}) {
  ...
  return <ActionDialog
    ...
    danger
    cancelButton
    okButton={{ label: "Delete Permission", onClick: async () => { await stackApp.deleteUserPermissionDefinition(props.permission.id); } }}
...
function Actions({ row, invisible }: { row: Row<AdminUserPermissionDefinition>, invisible: boolean }) {
...
const columns: ColumnDef<AdminUserPermissionDefinition>[] =  [
  {
    accessorKey: "id",
...
export function UserPermissionTable(props: { permissions: AdminUserPermissionDefinition[] }) {
  return <DataTable
