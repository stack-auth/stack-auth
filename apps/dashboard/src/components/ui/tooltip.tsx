...
>(({ className, sideOffset = 4, ...props }, ref) => (
  // Render in a portal so the tooltip escapes ancestor `overflow-hidden`
  // containers (e.g. data-grid cells / scroll containers), which would
  // otherwise clip it — most visibly on a table's top row.
