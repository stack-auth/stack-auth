          ...
          >
            {user.hasPassword && (
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  className="bg-white dark:bg-zinc-900 border-black/[0.08] dark:border-white/[0.08] rounded-xl px-3 py-2 shadow-sm focus-visible:ring-black/[0.06] dark:focus-visible:ring-white/[0.06]"
                />
            ...
            <div className="mt-4 flex gap-2">
              <Button
                type="submit"
                loading={loading}
                className="rounded-xl flex-1 bg-black text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
              >
                {user.hasPassword ? "Update Password" : "Set Password"}
              </Button>
              <Button
                ...
                className="border-black/[0.08] dark:border-white/[0.08] hover:bg-zinc-50 dark:hover:bg-zinc-900 rounded-xl flex-1"
              >
                Cancel
              </Button>
            </div>
