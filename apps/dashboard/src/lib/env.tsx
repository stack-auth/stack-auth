...
const _inlineEnvVars = {
  ...
  NEXT_PUBLIC_HEXCLAVE_ANALYTICS_BROWSER_TRACE_EXPORT_ENABLED: process.env.NEXT_PUBLIC_HEXCLAVE_ANALYTICS_BROWSER_TRACE_EXPORT_ENABLED,
...
const _postBuildEnvVars = {
  ...
  NEXT_PUBLIC_HEXCLAVE_ANALYTICS_BROWSER_TRACE_EXPORT_ENABLED: "STACK_ENV_VAR_SENTINEL_NEXT_PUBLIC_HEXCLAVE_ANALYTICS_BROWSER_TRACE_EXPORT_ENABLED",
