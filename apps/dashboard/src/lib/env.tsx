...
const _inlineEnvVars = {
  ...
  NEXT_PUBLIC_STACK_EMAIL_THEME_PROJECT_ID_FLAG: process.env.NEXT_PUBLIC_STACK_EMAIL_THEME_PROJECT_ID_FLAG,
} as const;
...
const _postBuildEnvVars = {
  ...
  NEXT_PUBLIC_STACK_EMAIL_THEME_PROJECT_ID_FLAG: "STACK_ENV_VAR_SENTINEL_NEXT_PUBLIC_STACK_EMAIL_THEME_PROJECT_ID_FLAG",
