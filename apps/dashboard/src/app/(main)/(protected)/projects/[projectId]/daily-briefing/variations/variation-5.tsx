...
// Interim preview — the "Cinema" design agent replaces this file with its
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-6 py-10">
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-dashed border-black/[0.12] px-5 py-4 dark:border-white/[0.14]">
        ...
        <p className="text-sm text-muted-foreground">
          The <span className="font-medium text-foreground">Cinema</span> design is being generated right now — this tab will
