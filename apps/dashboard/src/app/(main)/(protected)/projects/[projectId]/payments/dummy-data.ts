...
export const DUMMY_PAYMENTS_CONFIG: any = {
  ...
  offers: {
    ...
    "starter": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 999, interval: [1, "month"] as [number, "month"] },
        "yearly": { usd: 9990, interval: [1, "year"] as [number, "year"] },
      },
      includedItems: {
        "basic-features": { quantity: 1 },
    ...
    "professional": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 2999, interval: [1, "month"] as [number, "month"] },
        "yearly": { usd: 29990, interval: [1, "year"] as [number, "year"] },
        "quarterly": { usd: 8997, interval: [3, "month"] as [number, "month"] },
      },
      includedItems: {
    ...
    "business": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 9999, interval: [1, "month"] as [number, "month"] },
        "yearly": { usd: 99990, interval: [1, "year"] as [number, "year"] },
      },
      includedItems: {
        "pro-features": { quantity: 1 },
    ...
    "enterprise-standard": {
      ...
      serverOnly: false,
      prices: {
        "yearly": { usd: 299900, interval: [1, "year"] as [number, "year"] },
      },
      includedItems: {
    ...
    "extra-storage": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 499, interval: [1, "month"] as [number, "month"] },
      },
      includedItems: {
    ...
    "team-member-addon": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 1499, interval: [1, "month"] as [number, "month"] },
      },
      includedItems: {
    ...
    "premium-support": {
      ...
      serverOnly: false,
      prices: {
        "monthly": { usd: 29900, interval: [1, "month"] as [number, "month"] },
      },
      includedItems: {
