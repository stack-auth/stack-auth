...
import { CurrentUser, Project } from '@hexclave/react';
      ...
      <div className='flex flex-col gap-4 w-full md:w-[350px]'>
        {!isEnabled && generatedSecret && (
          <div className="flex flex-col gap-3">
            ...
            <div className={getInsetPanelClassName(design, "flex justify-center mx-auto p-2 bg-white w-[216px] h-[216px]")}>
            ...
            <Input
              ...
              maxLength={6}
              disabled={isLoading}
              className={getFieldClassName(design, "tracking-[0.2em] font-mono text-center text-lg")}
            />
