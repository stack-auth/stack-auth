...
export function Gitlab({ iconSize }: { iconSize: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} viewBox="0 -10 256 256" preserveAspectRatio="xMidYMid">
      <path d="M128.07485,236.074667 L175.17885,91.1043048 L80.9708495,91.1043048 L128.07485,236.074667 Z" fill="#E24329"/>
      <path d="M128.07485,236.074423 L80.9708495,91.104061 L14.9557638,91.104061 L128.07485,236.074423 Z" fill="#FC6D26"/>
      <path d="M14.9558857,91.1044267 L0.641828571,135.159589 C-0.663771429,139.17757 0.766171429,143.57955 4.18438095,146.06275 L128.074971,236.074789 L14.9558857,91.1044267 Z" fill="#FCA326"/>
      <path d="M14.9558857,91.1045486 L80.9709714,91.1045486 L52.6000762,3.79026286 C51.1408762,-0.703146667 44.7847619,-0.701927619 43.3255619,3.79026286 L14.9558857,91.1045486 Z" fill="#E24329"/>
      <path d="M128.07485,236.074423 L175.17885,91.104061 L241.193935,91.104061 L128.07485,236.074423 Z" fill="#FC6D26"/>
      <path d="M241.193935,91.1044267 L255.507992,135.159589 C256.813592,139.17757 255.38365,143.57955 251.96544,146.06275 L128.07485,236.074789 L241.193935,91.1044267 Z" fill="#FCA326"/>
      <path d="M241.193935,91.1045486 L175.17885,91.1045486 L203.549745,3.79026286 C205.008945,-0.703146667 211.365059,-0.701927619 212.824259,3.79026286 L241.193935,91.1045486 Z" fill="#E24329"/>
    </svg>
  );
}
...
export function Bitbucket({ iconSize }: { iconSize: number }) {
  return (
    <svg preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg" viewBox="-0.9662264221278978 -0.5824607696358868 257.93281329857973 230.8324730411935" width={iconSize} height={iconSize}>
      <linearGradient id="bitbucket-gradient" x1="108.633%" x2="46.927%" y1="13.818%" y2="78.776%">
        <stop offset=".18" stopColor="#0052cc"/>
        <stop offset="1" stopColor="#2684ff"/>
      </linearGradient>
      <path d="M101.272 152.561h53.449l12.901-75.32H87.06z" fill="none"/>
      ...
      <path d="M244.61 77.242h-76.916l-12.909 75.36h-53.272l-62.902 74.663a11.105 11.105 0 0 0 7.171 2.704H212.73a8.196 8.196 0 0 0 8.196-6.884z" fill="url(#bitbucket-gradient)"/>
    </svg>
  );
}
...
export function LinkedIn({ iconSize }: { iconSize: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" height={iconSize} width={iconSize} viewBox="0 0 310 310">
...
export function Apple({ iconSize }: { iconSize: number }) {
  return (
    <svg fill="#fff" height={iconSize} width={iconSize} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.773 22.773">
...
export function Twitch({ iconSize }: { iconSize: number }) {
  return (
    <svg aria-label="Twitch" viewBox="0 0 2400 2800" width={iconSize} height={iconSize} xmlns="http://www.w3.org/2000/svg">
