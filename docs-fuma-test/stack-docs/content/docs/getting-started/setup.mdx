...
<Tabs items={["Setup wizard (recommended)", "Manual installation"]}>
  <Tab value="Setup wizard (recommended)">
    <Steps>
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Run installation wizard</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Update API keys</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Done!</strong>
  ...
  <Tab value="Manual installation">
    ...
    <Steps>
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Install npm package</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Create API keys</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Create `stack.ts` file</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Create Stack handler</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Add StackProvider to `layout.tsx`</strong>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Add Suspense boundary</strong>
...
<Steps>
  ...
  <Step>
    <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Update `App.tsx`</strong>
...
<Tabs items={["Setup wizard (recommended)", "Manual installation"]}>
  ...
  <Tab value="Manual installation">
    <Steps>
      ...
      <Step>
        <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Initialize the app</strong>
        <Tabs items={["Server", "Client"]}>
          <Tab value="Server">
...
<Steps>
  ...
  <Step>
    <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Make a request</strong>
  ...
  <Step>
    <strong className="text-lg font-semibold mt-0 mb-2 block" data-toc-exclude>Retrieve the access tokens</strong>
