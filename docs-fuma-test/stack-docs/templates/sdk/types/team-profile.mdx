---
title: TeamProfile
description: The TeamProfile object represents the profile of a user within the context of a team. It includes the user's profile information specific to the team and can be accessed through the teamUser.teamProfile property on a TeamUser object.
full: true
---
