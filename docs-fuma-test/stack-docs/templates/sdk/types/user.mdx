---
title: User
description: The User object represents a user in the context of a project. It contains information about the user, such as their ID, display name, and profile image.
full: true
---
