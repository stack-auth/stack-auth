---
title: ApiKey
description: ApiKey represents an authentication token that allows programmatic access to your application's backend. API keys can be associated with individual users or teams.
full: true
---
