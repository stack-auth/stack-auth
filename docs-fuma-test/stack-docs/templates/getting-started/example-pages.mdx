...
<Tabs items={["index.html", "index-script.ts"]}>
  <Tab>
    ```html
    <!DOCTYPE html>
    <html lang="en">
...
<Tabs items={["password-sign-in.html", "password-sign-in-script.ts"]}>
  <Tab>
    ```html
    <!DOCTYPE html>
    <html lang="en">
...
<Tabs items={["password-sign-up.html", "password-sign-up-script.ts"]}>
  <Tab>
    ```html
    <!DOCTYPE html>
    <html lang="en">
...
<Tabs items={["otp-sign-in.html", "otp-sign-in-script.ts"]}>
  <Tab>
    ```html
    <!DOCTYPE html>
    <html lang="en">
...
<Tabs items={["oauth.html", "oauth-script.ts"]}>
  <Tab>
    ```html
    <!DOCTYPE html>
    <html lang="en">
